...
<body style="background-color: #efefef; display: flex; width: 100%; align-items: center">
    <main style="margin: auto; width: 100%; max-width: 540px; background-color: white; overflow-x: hidden;">
        ...
        <section style="min-height: 100vh; position: relative; padding: 32px;">
            <div
                ...
                <div
                    ...
                    <a href="#fec"
                        style="margin: 0 auto; margin-top: 18px; padding: 10px 28px; color: white; border-radius: 6px; border: 1px solid white; background-color: firebrick;">Buka
                        Undangan</a>
        ...
        <section id="fec"
            ...
            <div
                style="padding-bottom: 50px; margin-top: auto; position: relative; z-index: 10; color: firebrick; display: flex; flex-direction: column">
                <p style="width: 100%; text-align: center; font-size: 18px; ">The Wedding of</p>
                <p
                    style="width: 100%; font-weight: 600; text-align: center; font-size: 32px; margin-top: 6px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">
                    {{ $invitation->name }}
        ...
        <section style="position: relative; display: flex; flex-direction: column; margin-top: -20px;">
            ...
            <div style="padding: 80px 32px; background-color: firebrick; margin-top: -28px;">
        ...
        <section style="position: relative; display: flex; flex-direction: column; padding: 32px; margin-top: 42px;">
            <div
                style="padding: 3px; border-radius: 6px; background-color: firebrick; width: max-content; margin: 0 auto;">
            ...
            <p style="widht: 100%; text-align: center; margin-top: 28px; color: firebrick; font-size: 46px;">
                &
            </p>
            <div
                style="padding: 3px; border-radius: 6px; background-color: firebrick; width: max-content; margin: 28px auto 0 auto;">
        ...
        <!-- EVENTS -->
        <section
            style="position: relative; padding: 32px; margin-top: 42px; background-color: firebrick; color: white">
            ...
            @foreach ($invitationEvents as $invitationEvent)
                <div
                    ...
                    <div style="margin-top: -100px; position: relative; z-index: 10; padding: 0 16px;">
                        <p
                            style="font-size: 41px; color: firebrick; width: 100%; text-align: right; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-weight: 600">
                        ...
                        @if ($invitationEvent->latitude && $invitationEvent->longitude)
                            <a href="https://maps.google.com/?q={{ $invitationEvent->latitude }},{{ $invitationEvent->longitude }}"
                                style="font-size: 12px; background-color: firebrick; padding: 6px 12px; border-radius: 6px; color: white">Buka
                                Lokasi</a>
                        @endif
                    </div>
                </div>
        ...
        @if (count($invitationGifts) > 0)
            <section style="padding: 32px;">
                ...
                @foreach ($invitationGifts as $invitationGift)
                    <div
                        style="background-color: firebrick; width: 100%; padding: 32px; border-radius: 6px; margin-top: 16px; color: white">
        ...
        @endif
        <!-- GUEST BOX -->
        <section id="guestBooks" style="padding: 32px; background-color: firebrick; color: white">
            <p
                style="width: 100%; text-align: center; font-size: 39px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">
                Ucapkan Sesuatu
            </p>
            ...
            <form action="/{{ $invitation->slug }}?igc={{ $invitationGuest->code }}" method="POST"
                ...
                <button
                    style="padding: 10px 16px; border-radius: 6px; background-color: firebrick; color: white; border: 1px solid white; cursor: pointer; margin-top: 10px">Kirim</button>
            </form>
    ...
    <div style="height: 50px; width: 50px; border-radius: 100%; background-color: firebrick; position: fixed; top: 50%; left: 10px; cursor: pointer; display: flex; align-items: center; -webkit-animation:spin 4s linear infinite; -moz-animation:spin 4s linear infinite; animation:spin 4s linear infinite; z-index: 50"
        onclick="toggleSong()">
