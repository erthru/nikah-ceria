...
<body style="background-color: #efefef; display: flex; width: 100%; align-items: center">
    ...
    <div style="height: 50px; width: 50px; border-radius: 100%; background-color: midnightblue; position: fixed; top: 50%; left: 10px; cursor: pointer; display: flex; align-items: center; -webkit-animation:spin 4s linear infinite; -moz-animation:spin 4s linear infinite; animation:spin 4s linear infinite;"
        onclick="toggleSong()">
