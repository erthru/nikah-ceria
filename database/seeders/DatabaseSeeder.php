    ...
    public function run(): void
    {
        ...
        foreach ($products as $product) {
            ...
            $invitation = Invitation::create([
                ...
                'caption_1' => "Dalam hari yang indah ini, kami mengikatkan diri dalam janji abadi cinta dan kesetiaan. Di antara senyum bahagia, tawa yang tak terhitung, dan mata yang bercahaya, kami memulai babak baru dalam hidup kami bersama. Terima kasih kepada semua yang hadir dalam hari istimewa ini, yang telah membuatnya menjadi momen yang tak terlupakan. Kami berjanji untuk selalu bersama, melalui suka dan duka, dan untuk membangun masa depan yang penuh cinta dan harapan bersama. Ini adalah awal dari petualangan seumur hidup kami, dan kami sangat bersemangat untuk menghadapinya bersama-sama.",
                'caption_2' => 'Dalam cahaya matahari yang bersinar terang, kami berdua bersatu dalam cinta dan harapan. Hari ini adalah bukti dari perjalanan panjang kami bersama, di mana kami telah tumbuh bersama dalam kebahagiaan dan tantangan. Dalam momen ini, kami merayakan komitmen kami untuk menjalani sisa hidup bersama, untuk berbagi tawa, tangisan, dan segala yang ada di antaranya. Bersama-sama, kami akan mengukir kisah cinta yang tak terlupakan.',
